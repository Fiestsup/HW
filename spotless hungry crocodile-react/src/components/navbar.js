        ...
        <div data-thq="thq-navbar-nav" className="navbar-desktop-menu">
          <nav className="navbar-links1">
            ...
            <Banner2
              action1={
                <Fragment>
                  <span className="navbar-text1">Sign Up Now</span>
                </Fragment>
              }
              content1={
                <Fragment>
                  <span className="navbar-text2 thq-heading-3">
                    Enhance your cybersecurity skills with interactive
                    tutorials, forums, and case studies.
                  </span>
                </Fragment>
              }
              heading1={
                <Fragment>
                  <span className="navbar-text3 thq-heading-2">
